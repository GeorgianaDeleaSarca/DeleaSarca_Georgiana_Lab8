...
namespace DeleaSarca_Georgiana_Lab8.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(DeleaSarca_Georgiana_Lab8Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(DeleaSarca_Georgiana_Lab8Context context,
